...
for alg in "RFR" "LR" "MLP" "SVM" "NUSVM" "BFRA" "NUSVMSIG" "LSQLDA" "MULTICLASSLR" "RIDGEREGRESSION" "LASSOMODEL" "BAYESIANRIDGE" "KNRREGRESSOR" "KMEANS" "LARSLASSOR" "LSQLDA" "LINEARREGRESSION" "NONLINSVM" "NONLINSVMSIGMOID" "PERCEPTRONNEURALNET" "PERCEPTRONNEURALNETNONLINEARL1" "PERCEPTRONNEURALNETNONLINEARELASTIC" "RIDGECROSSVALIDATION" "RIDGECROSSVALIDATIONNORM" "KMEDIAN" "RANDOMFORRESTREGMAX" "PACCLASSWE" "EDT" "RANDOMDT" "KNCLASS" "KNCLASSMINKOW" "MLPNESTEROV" "OMPNONE" "PASSAGGCLASS" "PASSAGGCLASSEARLY" "RNRREG" "DISTRNRREG" "QDANN" "MLPCLASSALPHA" "GNBAYES" "ETCLASS"  "GNBAYESSMOOTHING"; do
