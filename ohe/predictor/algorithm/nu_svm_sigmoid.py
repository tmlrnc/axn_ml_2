...
@Commandline("NU_SVM_Sigmoid")
class NU_SVM_Sigmoid_OHP(OneHotPredictor):
    ...
    def __init__(self, target, X_test, X_train, y_test, y_train):
        ...
        self.model_name = 'Nu-Support Vector Classification Sigmoid'
    ...
    def predict(self):
        """
         ...
         """
        algorithm = NuSVC(kernel='sigmoid')
