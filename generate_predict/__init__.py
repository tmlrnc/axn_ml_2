...
class Downloader(object):
    ...
    def download_csv(self, target="tmp.csv", url="https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_US.csv"):
    ...
    def compare_csvs(self, source, target="tmp.csv"):
        ...
        if not os.path.exists(source):
            log.info(f"{source} does not exist, renaming {target}")
