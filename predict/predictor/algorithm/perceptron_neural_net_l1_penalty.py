...
@Commandline("PERCEPTRONNEURALNETNONLINEARL1")
class PERCEPTRON_NEURAL_NET_OHP(OneHotPredictor):
    ...
    def __init__(self, target, X_test, X_train, y_test, y_train):
        ...
        self.model_name = 'PERCEPTRONNEURALNETNONLINEARL1'
    ...
    def predict(self):
        """
         ...
         """
        algorithm = Perceptron(tol=1e-3, random_state=0,class_weight="balanced", penalty="l1")
