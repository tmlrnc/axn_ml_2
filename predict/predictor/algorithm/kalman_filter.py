...
Update of the variance uses the previous variances.
    ...
    def fit_KF(self,X_train_data, Y_train_data):
        ...
        #get mean and variance of X_train_data (mean1,var1) and mean and variance of Y_train_data (mean2,var2)
