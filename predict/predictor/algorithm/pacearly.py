...
import numpy as np
@Commandline("PASSAGGCLASSEARLY")
class PACE_OHP(OneHotPredictor):
    ...
    def __init__(self, target, X_test, X_train, y_test, y_train):
        ...
        self.model_name = 'PASSAGGCLASSEARLY'
    ...
    def predict(self):
        """
         ...
         """
        algorithm = PassiveAggressiveClassifier(max_iter=100, random_state=0,tol = 1e-3, early_stopping=True)
