...
python -m discrete  \
  --file_in csvs/2020_04_08_agg_covid_data_pivot_8.csv \
  --dicretize uniform   60  deaths  \
  --file_out_discrete csvs/2020_04_08_agg_covid_data_pivot_8_D.csv \
  --file_out csvs/2020_04_08_agg_covid_data_pivot_8_PLUS_D.csv
...
python -m predict  \
  ...
  --score recall \
  --file_out csvs/2020_04_08_agg_covid_data_pivot_8_PLUS_D_OHE_PREDICT.csv
