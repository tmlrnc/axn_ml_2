...
python -m ohe  \
  --file_in csvs/covid_11_pivot_death_uniform_D_250.csv \
  ...
  --file_out csvs/covid_11_pivot_death_uniform_D_250_OHE.csv
...
python -m predict  \
  ...
  --score recall \
  --file_out csvs/covid_11_pivot_death_uniform_D_250_OHE_PREDICT.csv