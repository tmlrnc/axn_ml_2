...
python -m ohe  \
  --file_in csvs/covid_10_pivot_death_uniform_D_OHE.csv \
  ...
  --file_out csvs/covid_10_pivot_death_uniform_D_OHE.csv
...
python -m predict  \
  ...
  --score recall \
  --file_out csvs/covid_10_pivot_death_uniform_D_OHE_PREDICT.csv