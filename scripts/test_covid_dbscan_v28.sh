...
python -m ohe  \
  --file_in csvs/covid_10_pivot_death_dbscan_D27.csv \
  ...
  --file_out csvs/covid_10_pivot_death_dbscan_D27_OHE.csv

python -m predict  \
  --file_in csvs/covid_10_pivot_death_dbscan_D27_OHE.csv \
  --strategy none \
  ...
  --score recall \
  --file_out csvs/covid_10_pivot_death_dbscan_D27_OHE_PREDICT.csv