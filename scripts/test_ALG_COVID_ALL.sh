...
for alg in  "SVM" "RF"   "EDT" "KNCLASSMINKOW" "RFR" "LR" "MLP" "BFRA"   "OMPCVCONT"   "LSQLDA" "MULTICLASSLR" "RIDGEREGRESSION" "LASSOMODEL" "RNRREG" "DISTRNRREG"  "NONLINSVMSIGMOID" "PERCEPTRONNEURALNET" "PERCEPTRONNEURALNETNONLINEARL1" "PERCEPTRONNEURALNETNONLINEARELASTIC" "RIDGECROSSVALIDATION" "RIDGECROSSVALIDATIONNORM" "RIDGECROSSVALIDATION" "RIDGECROSSVALIDATIONNORM" "KMEDIAN" "RANDOMFORRESTREGMAX" "PACCLASSWE" "EDT" "RANDOMDT" "KNCLASS" "KNCLASSMINKOW" "MLPNESTEROV" "OMPNONE" "PASSAGGCLASS" "MLPCLASSALPHA" "GNBAYES" "GNBAYESSMOOTHING"   ; do
