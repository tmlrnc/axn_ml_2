...
python -m discrete  \
  ...
  --dicretize uniform   400  7_deaths  \
    --dicretize uniform   400  6_deaths  \
      --dicretize uniform   400  5_deaths  \
        --dicretize uniform   400  4_deaths  \
          --dicretize uniform   400  3_deaths  \
            --dicretize uniform   400  2_deaths  \
                    --dicretize uniform   400  16_deaths  \
            --dicretize uniform   400  14_deaths  \
            --dicretize uniform   400  13_deaths  \
            --dicretize uniform   400  12_deaths  \
            --dicretize uniform   400  11_deaths  \
            --dicretize uniform   400  10_deaths  \
  --file_out_discrete csvs/covid_date_p5_out_d.csv \
  --file_out csvs/2020_04_08_agg_covid_data_pivot_5_out.csv
