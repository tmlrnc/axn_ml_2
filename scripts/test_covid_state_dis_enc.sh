...
python -m ohe  \
  --file_in csvs/covid_joe8_pivot_death_org1_D.csv \
  ...
  --file_out csvs/covid_joe8_pivot_death_org1_D_OHE.csv


python -m predict  \
  --file_in csvs/covid_joe8_pivot_death_org1_D_OHE.csv \
  --strategy none \
  ...
  --score recall \
  --file_out csvs/covid_joe8_pivot_death_org1_D_OHE_PREDICT.csv
