...
python -m ohe  \
  --file_in csvs/time_series_covid19_deaths_US_V4000_D.csv \
  ...
  --file_out csvs/time_series_covid19_deaths_US_V4000_D_OHE.csv
...
python -m predict  \
  ...
  --score recall \
  --file_out csvs/time_series_covid19_deaths_US_V4000_D_OHE_PREDICT.csv