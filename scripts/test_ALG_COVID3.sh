...
for alg in  "SVM" "RF"   "EDT" "KNCLASSMINKOW" "RFR" "LR" "MLP" "BFRA"   "OMPCVCONT"   "LSQLDA" "MULTICLASSLR" "RIDGEREGRESSION" "LASSOMODEL" "BAYESIANRIDGE"; do
    ...
    for I in 500 2000 4000 ; do
        for J in 500  2000 4000 ; do
        echo "Running $I $J"
       python -m discrete  \
