...
python -m ohe  \
  --file_in csvs/time_series_covid19_deaths_US_V2000_D.csv \
  ...
  --file_out csvs/time_series_covid19_deaths_US_V2000_D_OHE.csv

python -m predict  \
  --file_in csvs/time_series_covid19_deaths_US_V2000_D_OHE.csv \
  --strategy none \
  ...
  --score recall \
  --file_out csvs/time_series_covid19_deaths_US_V2000_D_OHE_PREDICT.csv