...
python -m ohe  \
  --file_in csvs/covid_10_pivot_death_dbscan_D25.csv \
  ...
  --file_out csvs/covid_10_pivot_death_dbscan_D25_OHE.csv

python -m predict  \
  --file_in csvs/covid_10_pivot_death_dbscan_D25_OHE.csv \
  --strategy none \
  ...
  --score recall \
  --file_out csvs/covid_10_pivot_death_dbscan_D25_OHE_PREDICT.csv